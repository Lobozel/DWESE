...
<html lang="es">
    ...
    <body>
    <?php
        //Comprobamos si hemos dado el boton submit o no
        if(isset($_POST['btnEnviar'])){
            ...
            //pintamos el formulario, este else se cierra al final antes de cerrar el body
    ...
    <div class="container mt-5">
        ...
        <div class="form-group">
            ...
            <input class="form-check-input" type="checkbox" id="gridCheck" name='cbop1' value=''>
            <label class="form-check-label" for="gridCheck">
                Opción 1 &nbsp;&nbsp;&nbsp;&nbsp; <!--&nbsp; es un espacio en blanco-->
            </label>
